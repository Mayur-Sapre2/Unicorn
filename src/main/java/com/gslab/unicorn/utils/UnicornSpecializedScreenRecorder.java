 ...
 * <p>
 * <p>
 * UnicornSpecializedScreenRecorder is use to set screen recorder configuration
 */

public class UnicornSpecializedScreenRecorder extends ScreenRecorder {
    private String name;

    public UnicornSpecializedScreenRecorder(GraphicsConfiguration cfg,
